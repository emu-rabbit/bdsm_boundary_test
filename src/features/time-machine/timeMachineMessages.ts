...
const zhHant: TimeMachineMessages = {
  ...
  picker: {
    ...
    loading: '正在讀取檔案…',
    localSource: '本地',
    localOnlyHint: '可以從本地檔案，或這台裝置已加入連結的雲端檔案中選擇。',
    manageFiles: '查看舊檔案',
  ...
  story: {
    ...
    conclusion: (gap) => [
      '這兩份檔案，都是當下最真實你的呈現。',
      '有些喜好，有些界線，可能流動也可能停留，這些都是自然無比的。',
      `這些沒有對錯，我們知道的是，你又往前走了${gap}這麼多的時間。`,
      '而你依舊還是你，慾望仍然還是慾望。',
      '準備好的話，我們就出發吧。',
    ],
    confirm: (olderDate, newerDate, gap) => `嗯……${olderDate}和${newerDate}的檔案？看來相隔了${gap}呢。準備好了嗎？`,
...
const zhHans: TimeMachineMessages = {
  ...zhHant,
  choices: {
    ready: '准备好了！', departReady: '准备好了', notReady: '还没。', great: '很棒呢', okay: '还好', notGood: '不太好…', proud: '（自豪）', maybe: '也许吧', hug: '(,,ᴗ ᴗ,,) ⁾⁾',
  ...
  picker: {
    changeFile: '更换档案', chooseFile: '选择档案', cloudFileFallback: '已链接的云端档案', cloudSource: '云端', cloudUploadedAt: (date) => `上传于 ${date}`, close: '关闭', createFile: '创建新档案', firstFile: '第一份档案', loadFailed: '无法读取选择的档案，请重新选择。', loading: '正在读取档案…', localSource: '本地', localOnlyHint: '可以从本地档案，或这台设备已添加链接的云端档案中选择。', manageFiles: '查看旧档案', needTwoFiles: '至少需要两份本地或已链接的云端档案，才能在两个时间点之间穿梭。', secondFile: '第二份档案', selectFileTitle: (position) => `选择${position}`, selectionRequired: '请先选择两份不同的档案。', updatedAt: (date) => `最后编辑于 ${date}`,
  },
  scopeLabel: (scope) => scopeLabels['zh-Hans'][scope],
  speakerName: secretKeeperNames['zh-Hans'],
  story: {
    allToSingle: (newScope) => `噢，这两份档案真特别，你后来选择只记录${newScope}了。`, allToSingleFocus: '原来如此，那我们就更专注地看着这一侧吧！', allToSingleStop: '原来如此，我想肯定有一些原因吧。', conclusion: (gap) => ['这两份档案，都是当下最真实的你。', '有些喜好，有些界限，可能流动也可能停留，这些都无比自然。', `这些没有对错。我们知道的是，你又向前走过了${gap}。`, '而你依旧还是你，欲望依然还是欲望。', '准备好的话，我们就出发吧。'], confirm: (olderDate, newerDate, gap) => `嗯……${olderDate}和${newerDate}的档案？看来相隔了${gap}呢。准备好了吗？`, differentProfile: '哦？两份档案的名称不一样呢，这之间看来有些改变，是吗？', focusReason: '原来如此，那我们就更专注地看着这一侧吧！', grandmother: '我家阿嬷最爱听故事了，关于页面里有她的 email，你可以考虑写信给她。', namePast: '那也许你可以把过去放在心中某一处，好好纪念着。', nameTrash: '真凶，但这魄力我喜欢w', newName: (name) => `${name}听起来的确是个很好的名字。`, sameActive: '来看看档案方向吧，看来你还是更专注地看着主导那侧的项目呢！', sameAll: '来看看档案方向吧，看来在两侧来回尝试，是你最想了解的自己。', sameBad: '噢，如果不介意的话，我可以抱抱你。', sameGood: '太好了，过得好比什么都棒！', sameOkay: '平淡的日子，有时候也是一种幸福。', samePassive: '来看看档案方向吧，看来你还是喜欢描述自己在配合那侧的喜好和经验呢！', sameProfile: (name, gap) => `${name}，这${gap}的日子，过得还好吗？`, select: '今天想要在哪两个档案之间穿梭呢？', singleToAll: (oldScope) => `哦？作答范围从${oldScope}变成了双侧都回答。怎么样，回答两倍的问题，有没有累坏呀？`, singleToSingle: (oldScope, newScope) => `哦？看起来，这两份档案的角度非常不一样。从${oldScope}到${newScope}，你要说说这之间的故事吗？`, storyPrivate: '不想说也没关系，谁没有几个自己的小秘密呢。', stole: '（呼叫时空警察）', systemArrested: '你因为冒用身份，被时空警察逮捕了！',
  },
